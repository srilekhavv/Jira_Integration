...
userProperties.setProperty('Access', 'text+":"+text2');
var base64pw = userProperties.getProperty('Access');*/

/**
 * Adds a custom menu to the active spreadsheet, containing a single menu item
 * for invoking the refresh() function specified above.
...
function refresh(){
  //SpreadsheetApp.getActiveSheet().getRange('Sheet3!B1').setValue(Math.random());
  var today = new Date();
  var date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate();
  var time = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();
  var dateTime = date+' '+time;
  SpreadsheetApp.getActiveSheet().getRange('Sheet3!B1').setValue(dateTime);
  ...
  var button = uname.getSelectedButton();
  var text = uname.getResponseText();
  if (button == ui.Button.OK) {
    // User clicked "OK".
    pass = ui.prompt(
      'Please enter your Jira password:',
      ui.ButtonSet.OK_CANCEL);
    var button2 = pass.getSelectedButton();
    var text2 = pass.getResponseText();
    if (button2 == ui.Button.OK){
      base64pw= Utilities.base64Encode(text+":"+text2);
    } 
  }*/
//}
 ...
 * @customfunction
 **/
/*function ImportJSON(url, query, options, ref) {
